...
-- Toggle the terminal in different modes
map("n", "<leader>tt", ":FTermToggle<CR>", { desc = "[t]oggle [t]erminal" })
map("v", "<leader>tt", ":FTermToggle<CR>", { desc = "[t]oggle [t]erminal" })
map("n", "<A-t>", ":FTermToggle<CR>", { desc = "Toggle [t]erminal" })
map("v", "<A-t>", ":FTermToggle<CR>", { desc = "Toggle [t]erminal" })
map("i", "<A-t>", ":FTermToggle<CR>", { desc = "Toggle [t]erminal" })
